...
Attendify uses three main MongoDB models:

### User

Stores application user information such as:
...
A unique employee-date combination helps prevent duplicate attendance records.
